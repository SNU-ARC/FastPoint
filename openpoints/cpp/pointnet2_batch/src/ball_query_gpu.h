...
int fused_ball_query_wrapper_fast(int b, int n, int m, at::Tensor radius, at::Tensor nsample, at::Tensor new_xyz_tensor, at::Tensor xyz_tensor, at::Tensor idx_tensor);
