...
#                import pickle
#                with open('/home2/dhlee/PointMetaBase/all_point.pkl', 'wb') as f:
#                    pickle.dump(support_xyz[0].clone().detach(), f)
#                with open('/home2/dhlee/PointMetaBase/idx.pkl', 'wb') as f:
#                    pickle.dump(idx[0].clone().detach(), f)
#                exit(0)
